...
namespace kartzmax.Migrations
{
    ...
    [Migration("20200601192014_PhotosTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kartzmax.Core.Models.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("kartzmax.Core.Models.VehicleFeature", b =>
                {
                    b.Property<int>("VehicleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("kartzmax.Core.Models.Photo", b =>
                {
                    b.HasOne("kartzmax.Core.Models.Vehicle", null)
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("kartzmax.Core.Models.VehicleFeature", b =>
                {
                    b.HasOne("kartzmax.Core.Models.Feature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("kartzmax.Core.Models.Vehicle", "Vehicle")
                        .WithMany("Features")
                        .HasForeignKey("VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
